...
This report creates the CSV files with the candidate differentially expressed regions (DERs) found using `derfinder` `r citep(bib[["derfinder"]])` via the single-base level approach on the _BrainSpan_ and _hippo_ data sets. It also has Venn diagrams illustrating the overlap with known annotation. 
