...
featCounts <- featureCounts(files = files, annot.ext = '/dcs01/ajaffe/Brain/derRuns/derSupplement/simulation/gtf/chr17-incomplete.gtf', isGTFAnnotationFile = TRUE, useMetaFeatures = TRUE, isPairedEnd = TRUE, nthreads = 4)
