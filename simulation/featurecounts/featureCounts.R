...
featCounts <- featureCounts(files = files, annot.ext = '/dcl01/lieber/ajaffe/derRuns/derSupplement/simulation/gtf/chr17.gtf', isGTFAnnotationFile = TRUE, useMetaFeatures = FALSE, isPairedEnd = TRUE, nthreads = 4, allowMultiOverlap = TRUE)
