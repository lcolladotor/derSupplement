...
foo <- function(i) {
    cat(paste0("/dcl01/lieber/ajaffe/Brain/derRuns/derSupplement/simulation/simulated_reads/sample_", sprintf('%02d', i), "_1.fasta.gz\t0\t/dcl01/lieber/ajaffe/Brain/derRuns/derSupplement/simulation/simulated_reads/sample_", sprintf('%02d', i), "_2.fasta.gz\t0\t", sampleNames[i], "\n"))
}
